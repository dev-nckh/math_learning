...
const images = {
  ...
  fish: require("../../../../../../../../../../../assets/images/ToanVo/images/mango.png"),
  bubble: require("../../../../../../../../../../../assets/images/ToanVo/images/mango.png"),
};

const MAX_QUESTIONS = 5;

interface SubtractionPracticeSceneProps {
  chapterId: string;
  lessonId: string;
  gameId: string;
  gameData: {
