...
const CAKE_IMAGE = require("../../../../assets/images/Cake1.png");
const ANT_IMAGE = require("../../../../assets/images/ant.png");
const OWL_TEACHER_IMAGE = require("../../../../assets/images/owl.png");
const OWL_CRY_IMAGE = require("../../../../assets/images/owl_cry.png");
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      Speech.stop();
                      setTimeout(
                        () => router.push("./SubtractCountScene"),
                        300
                      );
                    }}
                    activeOpacity={0.8}
...
export default SubtractLearnScene;
